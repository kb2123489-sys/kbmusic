...
**kb音乐下载站** 是一个基于 Next.js 16 构建的现代化音乐搜索与下载平台。界面设计简约纯净，支持多渠道音乐搜索、在线试听、批量下载，并配备了丝滑的暗黑模式（涟漪过渡动画）。

![网站预览](pics/PixPin_2026-01-19_17-58-43.png)
...
- **主题管理**: [next-themes](https://github.com/pakbursey/next-themes) + View Transitions API
...
```bash
git clone https://github.com/markcxx/kb-downloader.git
cd kb-downloader
```
